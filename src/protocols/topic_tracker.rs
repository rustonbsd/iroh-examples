...
use crate::wait_for_relay;

use super::gossip_info::from_z32;

#[derive(Debug, Clone)]
pub struct TopicTrackerProtocol {
    pub node_id: NodeId,
    endpoint: Endpoint,
...
impl TopicTrackerProtocol {
    ...
    pub async fn topic_request(self: Arc<Self>, topic: &Topic) -> Result<Vec<NodeId>> {
...
impl ProtocolHandler for TopicTrackerProtocol {
    fn accept(
        &self,
        conn: Connecting,
